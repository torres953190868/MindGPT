      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-8">
        ...
        >
          <div className="mb-8 flex items-start gap-4">
            <div className="grid h-12 w-12 shrink-0 place-items-center rounded-[18px] bg-[#f7d8e5] text-[#7c4e70] shadow-sm">
              <FileCheck size={23} />
            </div>
            <div className="space-y-3">
              ...
              <h1 id="terms-title" className="text-4xl font-black text-[#312737]">
                Terms of Use
              </h1>
