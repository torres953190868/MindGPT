  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-2xl border border-border-default bg-surface-elevated p-6 text-center shadow-xl sm:p-8">
        <p className="text-5xl font-black tracking-tight text-brand-900">出错了</p>
        <h1 id="error-page-title" className="mt-3 text-xl font-extrabold text-text-primary">
          页面加载时发生错误
        </h1>
        <p className="mt-1 text-sm font-semibold text-text-muted">Something went wrong</p>
        ...
        <p className="mt-2 text-xs text-text-muted">Try again · Back to home</p>
      </div>
    </main>
  );
}
